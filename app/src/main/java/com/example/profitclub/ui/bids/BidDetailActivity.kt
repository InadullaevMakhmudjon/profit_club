            ...
            when (role) {
                ...
                vm.data.observe(this, Observer { data ->
                    if(data != null) {
                        ...
                        deadline.text = data.question_date
                        time_left.text = " " + data.day_deadline.toString() + resources.getString(R.string.day) + " " +  + data.hour_deadline +resources.getString(R.string.hour)
