...
class OpenBidsFragment : Fragment(), View.OnClickListener {
    ...
    private lateinit var galleryViewModel: OpenBidsViewModel
    ...
    override fun onCreateView(
       ...
       // (activity as AppCompatActivity).supportActionBar?.setDisplayHomeAsUpEnabled(true)
        ...
        galleryViewModel =
            ViewModelProviders.of(this).get(OpenBidsViewModel::class.java)
       // val root = inflater.inflate(R.layout.fragment_questions, container, false)
        ...
        adapter = OpenBidAdapter(this.context!!, list, this)
