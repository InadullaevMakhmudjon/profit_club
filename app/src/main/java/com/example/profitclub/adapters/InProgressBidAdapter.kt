...
import com.example.profitclub.databinding.InprogressBidItemBinding
import com.example.profitclub.model.Bid
import com.example.profitclub.ui.bids.BidDetailActivity


class InProgressBidAdapter(context: Context, items: List<Bid>, listener: View.OnClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), View.OnClickListener {
...
//        if (viewType == TYPE_FEED) {
        val binding = InprogressBidItemBinding.inflate(inflater, parent, false)
...
//        return null
    ...
    private inner class EventFeedHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: InprogressBidItemBinding? = null
